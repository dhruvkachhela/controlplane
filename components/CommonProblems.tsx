...
export default function CommonProblems() {
  const problems = [
    ...
    },
    {
      ...
      solution: "NVIDIA NIM 8B + Prompt Compression: Strips prompt bloat and routes to high-speed Llama 3.1 8B, slashing compute costs by 52.9% while matching accuracy.",
    },
    {
      id: "04",
