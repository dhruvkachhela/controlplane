...
def generate_pdf_report(output_pdf_path: str, diagram_image_path: str) -> None:
    ...
    meta_data = [
        ...
        [Paragraph("<b>Primary Model:</b> Poolside Laguna 2.1 XS (NIM)", body_style), Paragraph("<b>Verified Net Savings:</b> ~38% Blended vs Frontier Models", body_style)],
    ...
    econ_rows = [
        ...
        [Paragraph("<b>Net Blended Cost</b>", table_cell_style), Paragraph("<b>100% Baseline</b>", table_cell_style), Paragraph("<b>62% Net Cost</b>", table_cell_style), Paragraph("<b>~38% Savings</b>", table_cell_style)],
    ]
