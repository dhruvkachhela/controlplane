...
def render_home_overview(pipeline: ControlPlanePipeline) -> None:
    ...
    with b_col2:
        st.markdown(
            ...
            <div class="benefit-card">
                ...
                <div class="benefit-title">~38% Compute Savings</div>
    ...
    with kpi_col2:
        st.markdown(render_metric_card("COST REDUCTION", "~38%"), unsafe_allow_html=True)
    with kpi_col3:
...
def render_interactive_page(pipeline: ControlPlanePipeline) -> None:
    ...
    if submit_button and active_user_query.strip():
        ...
        with tab_telemetry:
            ...
            sav_pct = getattr(output_payload, "cost_savings_pct", 38.0)
